...
export const Login: React.FC = () => {
    ...
    return (
        <div className="min-h-[100dvh] flex items-center justify-center py-4 px-4">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center pb-2 pt-6 px-6">
                    ...
                    <CardTitle className="text-2xl font-bold font-serif">Chào bạn trở lại</CardTitle>
                    <p className="text-muted-foreground text-sm mt-1">Đăng nhập vào tài khoản để tiếp tục</p>
                </CardHeader>
                ...
                <CardContent className="px-6 pb-6 pt-0">
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-3 py-2 text-sm bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500/50"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <Button type="button" variant="outline" size="sm" className="glass-card" disabled>
