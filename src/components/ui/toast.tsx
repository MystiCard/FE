...
>(({ className = '', ...props }, ref) => (
    <ToastPrimitives.Viewport
        ref={ref}
        className={`fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px] ${className}`.trim()}
        {...props}
    />
))
...
>(({ className = '', variant = 'default', ...props }, ref) => {
    const variants = {
        default: 'glass-card-strong border-white/20',
        success: 'glass-card-strong border-green-500/50 bg-green-500/10',
        error: 'glass-card-strong border-red-500/50 bg-red-500/10',
        warning: 'glass-card-strong border-amber-500/50 bg-amber-500/10',
    }
