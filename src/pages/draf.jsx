...
export const MarketplaceCheckoutPage: React.FC = () => {
    ...
    const { orderData, profile } = location.state || {};

    if (!orderData) return <div>Không tìm thấy thông tin đơn hàng</div>;
                            ...
                            <div className="pt-2 border-t border-white/10 space-y-2">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`flex-1 px-3 py-2 rounded-md border text-xs md:text-sm ${paymentMethod === 'WALLET'
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 px-3 py-2 rounded-md border text-xs md:text-sm ${paymentMethod === 'MOMO'
    ...
    try {
        ...
        navigate("/marketplace/checkout", {
            state: {
                ...
                profile: profile // Có thể gửi kèm profile để hiển thị lại thông tin người nhận
            }
        });
